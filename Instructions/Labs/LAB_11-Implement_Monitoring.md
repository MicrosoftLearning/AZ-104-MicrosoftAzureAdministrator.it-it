...
1. Selezionare **Abilita** accanto alla macchina virtuale.

1. Prendere le impostazioni predefinite, selezionare **Rivedi e abilita** e quindi **Abilita**.  
...
1. Continua a lavorare sull’avviso. Passare alla **scheda Azioni** , selezionare **Usa gruppi** di azioni e quindi selezionare **Crea gruppo** di azioni nel pannello **Seleziona gruppo** di azioni.
...
1. Dovrebbe essere ricevuta una notifica e-mail indicante **Avviso importante: La macchina virtuale di avviso di Monitoraggio di Azure è stata attivata...** In caso contrario, aprire il programma e-mail e cercare un’e-mail da azure-noreply@microsoft.com.
